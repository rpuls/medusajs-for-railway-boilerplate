...
var makeKeysFactory = function makeKeysFactory(globalKey) {
  var queryKeyFactory = {
    all: [globalKey],
...
var cartKeys = /*#__PURE__*/makeKeysFactory(CARTS_QUERY_KEY);
...
var useUpdatePaymentSession = function useUpdatePaymentSession(cartId, options) {
  ...
  return useMutation(function (data) {
    return client.carts.updatePaymentSession(cartId, data.provider_id, data);
  }, options);
};
var useRefreshPaymentSession = function useRefreshPaymentSession(cartId, options) {
  ...
  return useMutation(function (_ref) {
    var provider_id = _ref.provider_id;
...
var productKeys = /*#__PURE__*/makeKeysFactory(PRODUCTS_QUERY_KEY);
...
var shippingOptionKey = /*#__PURE__*/_extends({}, /*#__PURE__*/makeKeysFactory(SHIPPING_OPTION_QUERY_KEY), {
...
var regionsKey = /*#__PURE__*/makeKeysFactory(REGIONS_QUERY_KEY);
...
var returnReasonsKey = /*#__PURE__*/makeKeysFactory(RETURNS_REASONS_QUERY_KEY);
...
var swapKey = /*#__PURE__*/_extends({}, /*#__PURE__*/makeKeysFactory(SWAPS_QUERY_KEY), {
  cart: function cart(cartId) {
...
var orderKeys = /*#__PURE__*/_extends({}, /*#__PURE__*/makeKeysFactory(ORDERS_QUERY_KEY), {
  cart: function cart(cartId) {
...
var useOrderLookup = function useOrderLookup(query, options) {
  var _useMedusa3 = useMedusa(),
      client = _useMedusa3.client;
...
var customerKeys = /*#__PURE__*/_extends({}, /*#__PURE__*/makeKeysFactory(CUSTOMERS_QUERY_KEY), {
...
var giftCardKeys = /*#__PURE__*/makeKeysFactory(GIFT_CARDS_QUERY_KEY);
...
var collectionKeys = /*#__PURE__*/makeKeysFactory(COLLECTIONS_QUERY_KEY);
...
export { CartProvider, MedusaProvider, SessionCartProvider, cartKeys, collectionKeys, computeAmount, computeVariantPrice, customerKeys, formatAmount, formatVariantPrice, generateCartState, getVariantPrice, giftCardKeys, orderKeys, productKeys, useAddShippingMethodToCart, useCart, useCartOrder, useCartShippingOptions, useCartSwap, useCollection, useCollections, useCompleteCart, useCreateCart, useCreateCustomer, useCreateLineItem, useCreatePaymentSession, useCreateReturn, useCreateSwap, useCustomerOrders, useDeleteLineItem, useDeletePaymentSession, useGetCart, useGiftCard, useMeCustomer, useMedusa, useOrder, useOrderLookup, useProduct, useProducts, useRefreshPaymentSession, useRegion, useRegions, useReturnReason, useReturnReasons, useSessionCart, useSetPaymentSession, useShippingOptions, useStartCheckout, useUpdateCart, useUpdateLineItem, useUpdateMe, useUpdatePaymentSession };
