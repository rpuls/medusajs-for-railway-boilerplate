...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validated, orderService, order;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, orderService.createShipment(id, validated.fulfillment_id, (_a = validated.tracking_numbers) === null || _a === void 0 ? void 0 : _a.map(function (n) { return ({ tracking_number: n }); }), { no_notification: validated.no_notification })];
            case 2:
                _b.sent();
