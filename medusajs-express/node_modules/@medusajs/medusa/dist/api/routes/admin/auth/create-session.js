...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validated, authService, result, cleanRes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!config_1.default.jwtSecret) {
                    throw new medusa_core_utils_1.MedusaError(medusa_core_utils_1.MedusaError.Types.NOT_FOUND, "Please configure jwtSecret in your environment");
                }
            ...
            case 2:
                ...
                if (result.success && result.user) {
                    // Add JWT to cookie
                    req.session.jwt = jsonwebtoken_1.default.sign({ userId: result.user.id }, config_1.default.jwtSecret, {
                        expiresIn: "24h",
                    });
