...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, value, idempotencyKeyService, headerKey, idempotencyKey, error_1, orderService_1, returnService_1, eventBus_1, inProgress, err, _a, _b, key, error, _c, key, error, err_1;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                order = _a.sent();
                                _a.label = 4;
                            case 4: return [4 /*yield*/, orderService_1.withTransaction(manager).retrieve(id, {
