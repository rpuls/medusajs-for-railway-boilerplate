...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, discount_id, product_id, discountService, discount;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, discount_id = _a.discount_id, product_id = _a.product_id;
                discountService = req.scope.resolve("discountService");
                return [4 /*yield*/, discountService.removeValidProduct(discount_id, product_id)];
            case 1:
                _b.sent();
...
//# sourceMappingURL=remove-valid-product.js.map