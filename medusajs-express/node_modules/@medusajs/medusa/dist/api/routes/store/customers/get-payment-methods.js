...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, storeService, paymentProviderService, customerService, customer, store, methods;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                customer = _a.sent();
                return [4 /*yield*/, storeService.retrieve(["payment_providers"])];
            case 2:
                store = _a.sent();
                return [4 /*yield*/, Promise.all(store.payment_providers.map(function (next) { return __awaiter(void 0, void 0, void 0, function () {
                        var provider, pMethods;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    provider = paymentProviderService.retrieveProvider(next);
