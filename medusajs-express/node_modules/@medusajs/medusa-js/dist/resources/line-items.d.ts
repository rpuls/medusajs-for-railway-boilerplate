...
declare class LineItemsResource extends BaseResource {
     ...
     */
    create(cart_id: string, payload: StorePostCartsCartLineItemsReq): ResponsePromise<StoreCartsRes>;
    /**
     * Updates a line-item.
     ...
     * @return {ResponsePromise<StoreCartsRes>}
     */
    update(cart_id: string, line_id: string, payload: StorePostCartsCartLineItemsItemReq): ResponsePromise<StoreCartsRes>;
    /**
